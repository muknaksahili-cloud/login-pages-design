...
import {
  ...
  transition,
  trigger
} from "./chunk-EVKQ42I4.js";
import {
  DomSanitizer
} from "./chunk-3DSS5EWE.js";
import {
  HttpBackend,
  HttpClient
} from "./chunk-SLHQWRJ5.js";
import "./chunk-ZD7QPOBC.js";
import {
  Location,
  isPlatformBrowser
...
function takeUntilDestroyed(destroyRef) {
  ...
  const destroyed$ = new import_rxjs6.Observable((subscriber) => {
  ...
  return (source) => {
    return source.pipe((0, import_operators4.takeUntil)(destroyed$));
  };
}
...
function wrapIntoObservable(value) {
  if ((0, import_rxjs7.isObservable)(value)) {
    return value;
  }
  if (isPromise(value)) {
  ...
  return (0, import_rxjs7.of)(value);
}
function canUseDom() {
...
var NzConfigService = class _NzConfigService {
  configUpdated$ = new import_rxjs8.Subject();
  ...
  getConfigChangeEventForComponent(componentName) {
    return this.configUpdated$.pipe((0, import_operators6.filter)((n) => n === componentName), (0, import_operators6.map)(() => void 0));
  }
...
var BreakpointObserver = class _BreakpointObserver {
  ...
  _destroySubject = new import_rxjs9.Subject();
  constructor() {
  }
  ...
  observe(value) {
    ...
    let stateObservable = (0, import_rxjs9.combineLatest)(observables);
    stateObservable = (0, import_rxjs9.concat)(stateObservable.pipe((0, import_operators7.take)(1)), stateObservable.pipe((0, import_operators7.skip)(1), (0, import_operators7.debounceTime)(0)));
    return stateObservable.pipe((0, import_operators7.map)((breakpointStates) => {
      const response = {
        matches: false,
        breakpoints: {}
      };
  ...
  _registerQuery(query2) {
    ...
    const queryObservable = new import_rxjs9.Observable((observer) => {
      const handler = (e) => this._zone.run(() => observer.next(e));
      mql.addListener(handler);
      return () => {
        mql.removeListener(handler);
      };
    }).pipe((0, import_operators7.startWith)(mql), (0, import_operators7.map)(({
      matches
    }) => ({
      query: query2,
      matches
    })), (0, import_operators7.takeUntil)(this._destroySubject));
    const output = {
...
var NzResizeService = class _NzResizeService {
  ngZone = inject(NgZone);
  destroyRef = inject(DestroyRef);
  resizeSource$ = new import_rxjs11.Subject();
  listeners = 0;
  ...
  connect() {
    ...
    return this.resizeSource$.pipe((0, import_operators9.auditTime)(16), (0, import_operators9.finalize)(() => this.unregisterListener()));
  }
  disconnet() {
...
var NzDragService = class _NzDragService {
  ...
  requestDraggingSequence(event) {
    ...
    this.currentDraggingSequence = new import_rxjs11.Subject();
    return this.currentDraggingSequence.pipe((0, import_operators9.map)((e) => ({
      x: e.pageX - this.currentStartingPoint.x,
      y: e.pageY - this.currentStartingPoint.y
    })), (0, import_operators9.filter)((e) => Math.abs(e.x) > this.draggingThreshold || Math.abs(e.y) > this.draggingThreshold), (0, import_operators9.finalize)(() => this.teardownDraggingSequence()));
  }
...
var NzBreakpointService = class _NzBreakpointService {
  ...
  subscribe(breakpointMap, fullMap) {
    if (fullMap) {
      ...
      return this.resizeService.connect().pipe((0, import_operators9.map)(get), (0, import_operators9.startWith)(get()), (0, import_operators9.distinctUntilChanged)((x, y) => x[0] === y[0]), (0, import_operators9.map)((x) => x[1]));
    } else {
      const get = () => this.matchMedia(breakpointMap);
      return this.resizeService.connect().pipe((0, import_operators9.map)(get), (0, import_operators9.startWith)(get()), (0, import_operators9.distinctUntilChanged)());
    }
  }
...
var NzDestroyService = class _NzDestroyService extends import_rxjs11.Subject {
  ngOnDestroy() {
    this.next();
    this.complete();
  }
...
var _IconService = class _IconService {
  ...
  constructor(_antIcons) {
    ...
    this._jsonpIconLoad$ = new import_rxjs12.Subject();
  ...
  getRenderedContent(icon, twoToneColor) {
    ...
    const $iconDefinition = definition ? (0, import_rxjs12.of)(definition) : this._loadIconDynamically(icon);
    return $iconDefinition.pipe((0, import_operators10.map)((i) => {
      if (!i) {
        throw IconNotFoundError(icon);
      }
  ...
  _loadIconDynamically(type) {
    if (!this._http && !this._enableJsonpLoading) {
      return (0, import_rxjs12.of)(HttpModuleNotImport());
    }
    ...
    if (!inProgress) {
      ...
      const source = !this._enableJsonpLoading ? this._http.get(safeUrl, {
        responseType: "text"
      }).pipe((0, import_operators10.map)((literal) => __spreadProps(__spreadValues({}, icon), {
        icon: literal
      }))) : this._loadIconDynamicallyWithJsonp(icon, safeUrl);
      inProgress = source.pipe((0, import_operators10.tap)((definition) => this.addIcon(definition)), (0, import_operators10.finalize)(() => this._inProgressFetches.delete(type)), (0, import_operators10.catchError)(() => (0, import_rxjs12.of)(null)), (0, import_operators10.share)());
  ...
  _loadIconDynamicallyWithJsonp(icon, url) {
    return new import_rxjs12.Observable((subscriber) => {
      ...
      this._jsonpIconLoad$.pipe((0, import_operators10.filter)((i) => i.name === icon.name && i.theme === icon.theme), (0, import_operators10.take)(1)).subscribe((i) => {
        subscriber.next(i);
        clean();
      });
    });
...
var NzIconService = class _NzIconService extends IconService {
  ...
  platform = inject(Platform);
  configUpdated$ = new import_rxjs13.Subject();
  get _disableDynamicLoading() {
...
var NzIconDirective = class _NzIconDirective extends IconDirective {
  ...
  changeIcon2() {
    ...
    const svgOrRemove$ = wrapIntoObservable(this._changeIcon()).pipe(
      ...
      (0, import_rxjs13.debounceTime)(0, this.isBrowser ? import_rxjs13.animationFrameScheduler : import_rxjs13.asapScheduler),
      takeUntilDestroyed(this.destroyRef),
      (0, import_rxjs13.finalize)(removeTask)
    );
...
var NzMNContainerComponent = class _NzMNContainerComponent {
  config;
  instances = [];
  _afterAllInstancesRemoved = new import_rxjs14.Subject();
  ...
  onCreate(instance) {
    ...
    instance.onClose = new import_rxjs14.Subject();
    return instance;
  }
...
var NzMNComponent = class _NzMNComponent {
  cdr = inject(ChangeDetectorRef);
  destroyRef = inject(DestroyRef);
  animationStateChanged = new import_rxjs14.Subject();
  options;
  autoClose;
  closeTimer;
  userAction = false;
  ...
  ngOnInit() {
    ...
    if (this.options.nzAnimate) {
      ...
      this.animationStateChanged.pipe((0, import_operators11.filter)((event) => event.phaseName === "done" && event.toState === "leave"), (0, import_operators11.take)(1)).subscribe(() => {
